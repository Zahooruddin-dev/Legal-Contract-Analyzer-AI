	...
	if (typeof data === 'object' && !Array.isArray(data)) {
		return (
			<div className='space-y-1'>
				...
				{data.role && (
					<span className='text-xs italic opacity-80 block'>({data.role})</span>
				)}
		...
		<div className='bg-slate-900 border border-slate-800 rounded-2xl p-10 shadow-2xl'>
			...
			<div className='space-y-6'>
				...
				<div className='relative group'>
					...
					/>
					<div
						className={`h-40 border-2 border-dashed rounded-xl transition-all flex flex-col items-center justify-center gap-3 ${
							file
